...
<!-- Barra de Navegación -->
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(90deg, #1D3557, #4A6D7C);">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Actualizar producto</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">Actualizar</button>
                </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_disponibilidad" name="edit_disponibilidad" type="text"
                                placeholder="Producto">
                            <label class="text-primary" for="usuario"><i
                                    class="fa-solid fa-envelope me-2"></i>disponibilidad</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="disponibilidad" name="disponibilidad" type="text"
